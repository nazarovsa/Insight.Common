...
namespace Insight.DependencyInjection.Extensions
{
	public static class ServiceCollectionExtensions
	{
		public static IServiceCollection AsClosedTypesOf(this IServiceCollection services,
			Assembly assembly, Type implementedType, ServiceLifetime lifetime = ServiceLifetime.Scoped)
		{
			return services.AsClosedTypesOf(new[] {assembly}, implementedType, lifetime);
		}

		public static IServiceCollection AsClosedTypesOf(this IServiceCollection services,
			Assembly[] assemblies, Type implementedType, ServiceLifetime lifetime = ServiceLifetime.Scoped)
		{
		...
		{
			return services.RegisterDefaultImplementations(new[] {assembly}, lifetime);
		}

		public static IServiceCollection RegisterDefaultImplementations(this IServiceCollection services,
			Assembly[] assemblies, ServiceLifetime lifetime = ServiceLifetime.Scoped)
		{
